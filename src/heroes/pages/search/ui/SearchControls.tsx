...
export const SearchControls = () => {
  ...
  const setQueryParams = (name: string, value: string) => {
    //prev hace que se mantenga el valor anterior, y se le añada algo al final (en este caso 'name' value)
    ...
    <>
        <div className="flex flex-col lg:flex-row gap-4 mb-8">
          ...
          <div className="relative flex-1">
            ...
            //si no viene (??) entonces string vacío ('')
        ...
        >
          ...
          <div className="mt-4">
            ...
            <Slider 
              ...
              //al cambiar el valor de la barra, esto modifica el URL
